...
type Subject = { id: string; label: string; pricePerMonth: number; };
        ...
        {pageState === 'form' && student && (
          <div className="cl-form-wrap">
            ...
            <div className="cl-card">
              ...
              <button type="button"
                className={`cl-submit${selected.length === 0 || submitting ? ' cl-submit--disabled' : ''}`}
                disabled={selected.length === 0 || submitting} onClick={handleSubmit}>
